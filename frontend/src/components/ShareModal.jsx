...
const ShareModal = ({ treeId, onClose, currentUserRole }) => {
  const [activeTab, setActiveTab] = useState(
    currentUserRole === "viewer" ? "link" : "invite"
  );
  ...
  // Permissions
  const canInvite = ["owner", "editor"].includes(currentUserRole);
  const isOwner = currentUserRole === "owner"; // ✅ Check for Owner
  ...
  const confirmRemove = async () => {
    ...
    try {
      ...
      setCollaborators((prev) =>
        prev.filter((c) => c.user._id !== userToRemove.user._id)
      );
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Tabs */}
        <div
          className={`flex p-2 gap-2 border-b flex-shrink-0 ${
            isDarkMode ? "border-slate-800" : "border-gray-100"
          }`}
        >
          {canInvite && (
        ...
        <div className="p-5 sm:p-6 overflow-y-auto custom-scrollbar flex-1">
          {activeTab === "invite" && canInvite ? (
              ...
              <div className="space-y-4">
                <div className="relative">
                  ...
                  {searchResults.length > 0 && (
                    <div
                      className={`absolute top-full left-0 right-0 mt-2 rounded-xl shadow-xl z-10 border max-h-40 overflow-y-auto
                      ${
                        isDarkMode
                ...
                <form
                  ...
                  className="space-y-4 pt-2 border-t border-dashed border-gray-200 dark:border-slate-700"
                >
                  <div>
                  ...
                  <div>
                    ...
                    <div
                      className={`grid grid-cols-2 gap-3 p-1 rounded-xl border ${
                        isDarkMode
                  ...
                  {Array.isArray(collaborators) &&
                    collaborators.map((c) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${
                              isDarkMode ? "bg-slate-700" : "bg-white border"
                            }`}
                          >
                          ...
                          <div>
                            ...
                            <p className="text-xs opacity-60 mt-1 flex items-center gap-1">
                              ...
                              {!c.accepted && (
                                <span className="text-amber-500 font-bold ml-1 text-[10px] uppercase border border-amber-500/50 px-1 rounded">
                                  Pending
                                </span>
                              )}
                            </p>
                        ...
                        {/* ✅ CONDITIONAL RENDER: Only Owner sees Trash Icon */}
                        {isOwner && (
                          <button
                            onClick={() => initiateRemove(c)}
            ...
            <div className="space-y-6">
              ...
              <div
                className={`p-4 rounded-xl text-xs leading-relaxed border flex gap-3 ${
                  isDarkMode
              ...
              >
                ...
                <p>
                  For security, users joining via link will be added as{" "}
                  <b>Viewers</b> by default. You can upgrade them to Editors
                  later.
                </p>
              </div>
        ...
        {userToRemove && (
          <div
            className="absolute inset-0 bg-black/50 flex items-center justify-center z-[110] backdrop-blur-sm p-6"
            onClick={(e) => e.stopPropagation()}
          >
            <div
              className={`p-6 rounded-3xl w-full max-w-sm shadow-2xl border ${
                isDarkMode
            ...
            >
              <div className="text-center">
                ...
                <h3 className="text-lg font-bold mb-2">Remove Access?</h3>
                <p
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 py-2.5 bg-red-600 text-white rounded-xl font-bold text-sm hover:bg-red-700 transition shadow-lg shadow-red-500/30"
                  >
                    Remove
                  </button>
                </div>
